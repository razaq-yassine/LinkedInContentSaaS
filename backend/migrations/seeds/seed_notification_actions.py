...
def get_default_preferences(action_code: str) -> tuple[bool, bool]:
    """
    Get default email and push preferences for a notification action.
    Returns (email_enabled, push_enabled)
    """
    defaults = {
        # ACCOUNT category - all OFF
        ...
        "post_scheduled": (False, True),  # Email OFF, Push ON
        
        # SUBSCRIPTION category - all ON
    ...
    try:
        ...
        for action_data in actions_data:
            ...
            if not existing_action:
                ...
                # Create default preference based on action type
                email_enabled, push_enabled = get_default_preferences(action_data["action_code"])
