            ...
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8">
                ...
                <div className="space-y-4 text-slate-400">
                  ...
                  <p><strong className="text-white">Our Services:</strong> PostInAi, including our AI models, software, and branding, are owned by Smart Technologies MA LLC and protected by intellectual property laws.</p>
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8">
                ...
                <div className="space-y-4 text-slate-400">
                  ...
                  <p>Any disputes shall be resolved through binding arbitration in Sheridan, Wyoming, in accordance with the rules of the American Arbitration Association.</p>
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8">
                ...
                <div className="text-slate-400">
                  ...
                  <div className="space-y-2">
                    ...
                    <p><strong className="text-white">Address:</strong> Smart Technologies MA LLC, 30 N Gould St, Ste R, Sheridan, WY 82801, USA</p>
                  </div>
                </div>
              </div>
