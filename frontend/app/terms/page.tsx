          ...
          <div className="container mx-auto px-4 lg:px-8 relative">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-slate-400">
                Please read these Terms of Service (&quot;Terms&quot;) carefully before using ContentAI&apos;s services. By accessing or using our services, you agree to be bound by these Terms.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8">
                ...
                <div className="space-y-4 text-slate-400">
                  <p>By creating an account or using ContentAI services, you agree to these Terms of Service, our Privacy Policy, and any additional terms that may apply. If you do not agree, do not use our services.</p>
                  <p>You must be at least 18 years old and capable of forming a binding contract to use our services. By using ContentAI, you represent that you meet these requirements.</p>
                </div>
              </div>
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8">
                ...
                <div className="space-y-4 text-slate-400">
                  <p>ContentAI provides AI-powered content generation services for LinkedIn, including:</p>
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8">
                ...
                <div className="space-y-4 text-slate-400">
                  ...
                  <p><strong className="text-white">Our Services:</strong> ContentAI, including our AI models, software, and branding, are owned by ContentAI Inc. and protected by intellectual property laws.</p>
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8">
                ...
                <div className="space-y-4 text-slate-400">
                  <p>You may not use ContentAI to:</p>
                  <ul className="space-y-2 ml-4">
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8">
                ...
                <div className="space-y-4 text-slate-400">
                  ...
                  <p>You waive any right to participate in class action lawsuits against ContentAI.</p>
                </div>
              </div>
