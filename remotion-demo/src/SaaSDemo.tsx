  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0F172A" }}>
      ...
      <Sequence from={135} durationInFrames={30}>
        <Audio src={staticFile("whoosh-transition.mp3")} volume={1.0} />
      </Sequence>
      ...
      {/* Typing sound - Welcome text (frames 160-175) */}
      <Sequence from={160} durationInFrames={15}>
        <Audio src={staticFile("keyboard-type.mp3")} volume={0.7} />
      </Sequence>
      {/* Typing sound - Subtitle text (frames 177-197) */}
      <Sequence from={177} durationInFrames={20}>
        <Audio src={staticFile("keyboard-type.mp3")} volume={0.7} />
      </Sequence>
      {/* Bubble pop - Form stacking */}
      <Sequence from={200} durationInFrames={15}>
        <Audio src={staticFile("pop-bubble.mp3")} volume={1.0} />
      </Sequence>
      {/* Cursor click - LinkedIn button */}
      <Sequence from={265} durationInFrames={50}>
        <Audio src={staticFile("cursor-click.mp3")} volume={1.0} />
      </Sequence>

      {/* Scene 4: Onboarding - Sounds */}
      {/* File drop - Using whoosh sound */}
      <Sequence from={365} durationInFrames={30}>
        <Audio src={staticFile("file-drop.mp3")} volume={1.0} />
      </Sequence>
      {/* AI Processing */}
      <Sequence from={390} durationInFrames={45}>
        <Audio src={staticFile("ai-processing.mp3")} volume={1.0} />
      </Sequence>
      ...
      <Sequence from={765} durationInFrames={45}>
        <Audio src={staticFile("keyboard-type.mp3")} volume={1.0} />
      </Sequence>
      ...
      <Sequence from={1125} durationInFrames={40}>
        <Audio src={staticFile("success-chime.mp3")} volume={1.0} />
      </Sequence>
      {/* Confetti pop */}
      <Sequence from={1125} durationInFrames={30}>
        <Audio src={staticFile("confetti-pop.mp3")} volume={1.0} />
      </Sequence>

      {/* Scene 8: Engagement - Sounds */}
      {/* Notification pings - Reactions appearing */}
      <Sequence from={1285} durationInFrames={15}>
        <Audio src={staticFile("notification-ping.mp3")} volume={1.0} />
      </Sequence>
